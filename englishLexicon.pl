...
lexEntry(noun,[symbol:egg,syntax:[egg]]).
lexEntry(noun,[symbol:milk,syntax:[milk]]).
lexEntry(noun,[symbol:salt,syntax:[salt]]).
lexEntry(noun,[symbol:butter,syntax:[butter]]).
lexEntry(noun,[symbol:bacon,syntax:[bacon]]).
lexEntry(noun,[symbol:potatoes,syntax:[potatoes]]).
lexEntry(noun,[symbol:onion,syntax:[onion]]).
lexEntry(noun,[symbol:cheese,syntax:[cheese]]).
lexEntry(noun,[symbol:pepper,syntax:[pepper]]).
lexEntry(noun,[symbol:recipe,syntax:[recipe]]).
lexEntry(noun,[symbol:flour,syntax:[flour]]).
lexEntry(noun,[symbol:mashedpotatoes,syntax:[mashed,potatoes]]).
lexEntry(noun,[symbol:fakeblueberrycheesecake,syntax:[fake,blueberry,cheesecake]]).
lexEntry(noun,[symbol:kluski,syntax:[kluski]]).
lexEntry(noun,[symbol:busiaspolishkluski,syntax:[busia,s,polish,kluski]]).
lexEntry(noun,[symbol:cheeseomelette,syntax:[cheese,omelette]]).
lexEntry(noun,[symbol:bakedeggsonabedofpotatoeswithbacon,syntax:[baked,eggs,on,a,bed,of,potatoes,with,bacon]]).
...
lexEntry(tv,[symbol:want,syntax:[want],inf:inf,num:sg]).
...
lexEntry(prep,[symbol:for,syntax:[for]]).
